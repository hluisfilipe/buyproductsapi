...
import com.hf.buyproductsapi.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat8 = new Categoria(null, "ToDelete");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "helfil.cursos@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363623", "93838393"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apro 303", "Jardim", "38220834", cli1, c1);
