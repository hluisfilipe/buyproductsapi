...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.hf.buyproductsapi.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
		"API de Spring Boot",
		"Esta API é utilizada para testes",
		"Versão 1.0",
		"https://www.hf.com/terms",
		new Contact("Helder", "hf.com", "hf@gmail.com"),
